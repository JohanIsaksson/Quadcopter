...
#define FRAME_SYNC_PERIOD  4000	   // total frame duration in microseconds
...
static boolean1 isStarted = false;  // flag to indicate if the ISR has been initialised
